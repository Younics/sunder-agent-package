...
/// contribute implementations through <see cref="PackageExtensionPoints.SystemPromptContributors"/>,
/// and the Agent Runtime consumes all registrations when composing each model request.
/// </para>
/// <para>
